...
#passo 1 - extrai todas as mensagems do grupo de milhas do telegram
...
async def main(phone):
    ...
    start_date = datetime(2023, 3, 25, 0, 0)  # replace with your desired date or comment for get all datas
